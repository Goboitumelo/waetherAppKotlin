package com.goboitumelo.weatherappkotlin.activities
...
import com.goboitumelo.weatherappkotlin.R
import com.goboitumelo.weatherappkotlin.models.WeatherResponse
import com.goboitumelo.weatherappkotlin.network.WeatherService
import com.goboitumelo.weatherappkotlin.utils.Constants
    ...
    private fun setupUI() {
        ...
        if (!weatherResponseJsonString.isNullOrEmpty()) {
            ...
            for (z in weatherList.weather.indices) {
                ...
                tv_sunrise_time.text = unixTime(weatherList.sys.sunset.toLong())
                tv_sunset_time.text = unixTime(weatherList.sys.sunrise.toLong())
